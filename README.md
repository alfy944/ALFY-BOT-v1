...
- **Break-even protetto**: gli stop vengono spostati sull'entry solo dopo un buffer minimo di profitto (`BE_MIN_R`, default 0.1R) e vengono offsettati di `BE_FEE_BUFFER_PCT` (default 0.08%, adattato alla leva attiva) per coprire fee e slippage, così da evitare chiusure in leggero loss.
